...
The header file was given to us by professor
The linkedListAPI.c was done by the students
*/
/**
...
*@param list a pointer to the dummy head of the list containing function pointers for delete as well 
